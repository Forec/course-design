...
public class _14211457_王耀_1_StudentList {
	private List<_14211457_王耀_1_Student> stuList; 
	public _14211457_王耀_1_StudentList(){
		stuList = new ArrayList<_14211457_王耀_1_Student>();
		stuList.clear();
	}
	public boolean addStudent(_14211457_王耀_1_Student student){
	...
	public boolean deleteStudentByNumber(String number){
		for (_14211457_王耀_1_Student s: stuList){
	...
	public _14211457_王耀_1_Student indexOf(int index){
		try{
	...
	public _14211457_王耀_1_Student indexByNumber(String number){
		for (_14211457_王耀_1_Student s: stuList){
			if (s.getNumber().equals(number)){
				return s;
			}
