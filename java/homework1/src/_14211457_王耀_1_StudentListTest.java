...
public class _14211457_王耀_1_StudentListTest {
	private static _14211457_王耀_1_Student generateStudentFromInput(Scanner in){
	...
	public static void main(String []argv){
		_14211457_王耀_1_StudentList sList = new _14211457_王耀_1_StudentList();
		...
		while (!exit){
			...
			switch (choice){
			case 1:
				_14211457_王耀_1_Student s = generateStudentFromInput(in);
				if (s == null){
